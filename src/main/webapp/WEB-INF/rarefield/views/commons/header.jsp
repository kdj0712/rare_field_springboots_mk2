            ...
            <div class="container-fluid">
                <div
                        ...
                        <%-- 로그인이 안된상태 --%>
                            ...
                            <%-- 로그인이 된 상태 --%>
                                <sec:authorize access="isAuthenticated()">
                                    ...
                                    <li class="nav-item"><a href="/user_mypage"
                                            class="nav-link text-secondary fw-bold">마이페이지</a>
                                    </li>
                    ...
                    <div class="aside in dropdown-menu container" aria-labelledby="dropdownMenuLink" id="m_menu_aside" style="width: 1920px;">
                        ...
                        <div class="dropdown">
                            <!-- 모바일에서는 dropdown, 데스크톱에서는 dropstart -->
                            ...
                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink" id="m_menu_aside">
                                <nav id="m_nav" role="navigation" class="row justify-content-center">
                                    <ul class="th1 col-lg-2 col-12 text-decoration-none">
                                        <div id="field">
                                            최신마당
                                        </div>
                                        <li class="menu_li dropdown-item" data-url="/trend/news?currentPage=1">
                                    ...
                                    <ul class="th1 col-lg-2 col-12">
                                        ...
                                        <li class="th2_in dropdown-item"
                                            data-url="/info/info_academicinfo_pub_med">
                                            해외 학술정보
                                        </li>
                                    </ul>
                                    <ul class="th1 col-lg-2 col-12">
                                        ...
                                        <li class="menu_li dropdown-item"
                                            data-url="/empo_community/selectSearch">
                                            커뮤니티
                                        </li>
                                        <li class="th2_in dropdown-item" data-url="/empo_program">
                                            프로그램
